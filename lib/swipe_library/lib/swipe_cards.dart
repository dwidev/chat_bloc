...
import 'package:chat_bloc/swipe_library/lib/cards_animations.dart';
...
class SwipeCards extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SwipeCardsState();
}
...
class _SwipeCardsState extends State<SwipeCards> {
  ...
  @override
  void dispose() {
    print("DISPOSING SWIPE CARDS $this");
    if (_currentItem != null) {
...
class MatchEngine extends ChangeNotifier {
  ...
  // bool get curentItemAlreadyExist {
  //   print(currentItem?.key);
  //   return _swipeItems?.where((e) => e.key == currentItem?.key).isNotEmpty ??
  //       false;
  // }
  ...
  void cycleMatch() {
    if (currentItem!.decision != Decision.undecided) {
      ...
      // if (_swipeItems?.isNotEmpty ?? false) {
      //   _swipeItems?.removeWhere((e) => e.key == currentItem?.key);
      // }
      notifyListeners();
    }
  }
...
class SwipeItem extends ChangeNotifier {
  ...
  final Future<dynamic> Function(SlideRegion? slideRegion)? onSlideUpdate;
